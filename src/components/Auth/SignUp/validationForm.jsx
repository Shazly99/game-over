...
export default function SignUpForm(e) {
  ...
  return <> <form className='auth__form ' onSubmit={e.handleSubmit}>
    ...
    <span className='text-muted pt-3  small text-center'>This site is protected by reCAPTCHA and the Google
    ...
    <div className="text-center">
      <span style={{ fontSize: '16px' }} className="small">Already a member?</span>
      <Link to={'/login'} className="small  text__blue cursor"  >Log In<Icons.ChevronR size={20} /> </Link>
    </div>
  </>
}